...
//   im_spr_dangerous_davePalLen); dmaCopy(im_spr_dangerous_daveTiles,
//   SPRITE_GFX, im_spr_dangerous_daveTilesLen);
// }
...
//                             (0 << 10) |              /* gfx mode */
//                             (0 << 12) |              /* mosaic */
//                             (1 << 13) |              /* color mode, 0:16,
//                             1:256 */ (OBJ_SQUARE);            /* shape */
...
//   {
//     // if (player->isJumping) {
//     //     player->firstFrame = player->facingLeft ? JUMPING_LEFT :
//     JUMPING_RIGHT;
//     //     player->animFrame = 0;
//     // } else {
//     player->firstFrame = player->facingLeft ? WALKING_LEFT : WALKING_RIGHT;
//     anim_seq = (anim_seq + 1) % WALK_SEQ_LEN;
...
//   player->spriteAttribs->attr2 = player->firstFrame + (player->animFrame *
//   8);
// }
...
//   vec.y = p->spriteAttribs->attr0 & 0x00FF;
//   // This attribute uses the lower 9 bits
//   vec.x = p->spriteAttribs->attr1 & 0x01FF;
//   return vec;
// }

// void player_setScreenPos(Player *p, Vec_u16 pos)
// {
//   p->spriteAttribs->attr1 = (p->spriteAttribs->attr1 & 0xFE00) | (0x01FF &
//   pos.x); p->spriteAttribs->attr0 = (p->spriteAttribs->attr0 & 0xFF00) |
//   (0x00FF & pos.y);
// }
...
//   if (neg)
//   {
//     offx = CENTER_PLAYER_SCREEN_X - offs.x;
//     offy = CENTER_PLAYER_SCREEN_Y - offs.y;
//   }
//   else
//   {
//     offx = CENTER_PLAYER_SCREEN_X + offs.x;
...
//   p->spriteAttribs->attr1 = (p->spriteAttribs->attr1 & 0xFE00) | (0x01FF &
//   offs.x); p->spriteAttribs->attr0 = (p->spriteAttribs->attr0 & 0xFF00) |
//   (0x00FF & offs.y);
// }
...
// {
//   p->spriteAttribs->attr0 = (p->spriteAttribs->attr0 & 0xFF00) | (0x00FF &
//   y);
// }
