...
{
  this->spriteAttribs->attr1 = (this->spriteAttribs->attr1 & 0xFE00) | (0x01FF & pos.x);
  this->spriteAttribs->attr0 = (this->spriteAttribs->attr0 & 0xFF00) | (0x00FF & pos.y);
}
...
void player_setScreenOffset(Player *this, Vec_u16 offs, bool neg)
{
  ...
  this->spriteAttribs->attr1 = (this->spriteAttribs->attr1 & 0xFE00) | (0x01FF & offs.x);
  this->spriteAttribs->attr0 = (this->spriteAttribs->attr0 & 0xFF00) | (0x00FF & offs.y);
}
